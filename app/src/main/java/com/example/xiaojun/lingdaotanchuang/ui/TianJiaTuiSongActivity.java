...
public class TianJiaTuiSongActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tian_jia_tuisong);

        zhujidizhi=getIntent().getStringExtra("tuisongdizhi");
        ...
        Reservoir.getAsync("tuisongdizhi", resultType, new ReservoirGetCallback<List<ZhuJiBean>>() {
            ...
            public void onFailure(Exception e) {
                TastyToast.makeText(TianJiaTuiSongActivity.this, e.getMessage(), Toast.LENGTH_SHORT,TastyToast.ERROR).show();
             //   finish();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                quchu.add(bean);
                    ...
                    Reservoir.putAsync("tuisongdizhi", quchu, new ReservoirPutCallback() {
                        @Override
                    ...
                    TastyToast.makeText(TianJiaTuiSongActivity.this, "你没有填写地址", Toast.LENGTH_SHORT,TastyToast.ERROR).show();
                }
            }
        });
